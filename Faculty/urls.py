...
urlpatterns = [
    ...
    path('streak_maintainer/',views.streak_maintainer,name='faculty_streak_maintainer'),
    path('streak_maintainer/<int:class_link_id>/',views.streak_maintainer,name='faculty_streak_maintainer'),
    ]
